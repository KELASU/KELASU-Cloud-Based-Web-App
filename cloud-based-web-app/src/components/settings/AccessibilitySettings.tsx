...
export function AccessibilitySettings() {
  ...
  return (
    <div className="p-4 border-4 border-[var(--primary)]/50 rounded-lg">
      ...
      {isColorblindMode && (
        <div className="mt-4 pt-4 border-t-4 border-[var(--primary)]/50">
          ...
          <select
            ...
            className="w-full p-2 border border-[var(--primary)]/80 rounded bg-[var(--background)]"
          >
