...
export async function POST() {
  ...
  try {
    // FIX: Switched to "gemini-pro" which is the widely available stable model
    // If you specifically want flash, try "gemini-1.5-flash-latest" or ensure your API key supports it
    ...
    try {
        ...
        // Fallback if JSON parsing fails (Gemini Pro sometimes chats instead of just JSON)
